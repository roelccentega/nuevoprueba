...
@section('title','Aprueba tu examen parcial, Tiendas virtuales diseño único.')
@section('description','
Te ofrecemos tu tienda virtual totalmente funcional, para un 20 de nota. ')
@section('url', url()->current())
@section('image','https://www.ccentesystem.com/landing/tienda-examen.jpg')
@section('keywords','paypal, ecommerce, tienda, web')
            ...
            <nav class="navbar navbar-expand-lg fixed-top">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="/" title="Ir a la página de inicio">
                        <img src="{{asset('/landing/logo-ccente-system1.png')}}" alt="Ccente System" title="Ccente System">
                    </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-12 col-sm-7">
                        ...
                        <div class="hero-text contact-form">
                            ...
                            <h3>Solicita tu tienda virtual compañero!!!</h3>
                            <form action=""  id="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <span>Tu nueva idea de tienda, tu empresa actual o el proyecto que quieres implementar</span>
                                </div>
                        ...
                        <div class="newsletter-bloc-inner">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-xs-12 col-sm-7">
                                    ...
                                    <h3>Desarrollo de Tiendas Virtuales Profesionales desde s/. 250.00</h3>
                                    <p> Diseño y Desarrollo Unico.</p>
                                ...
                                <div class="col-md-4 col-xs-12 col-sm-4 text-right ">
                                    <div class="btn-pdf">
                                        <a href="{{asset('/landing/examen-parcial-tienda.pdf')}}" target="_blank" title="Paquete de promoción Web profesional"> Examén tienda Virtual<i class="fa fa-file-pdf-o"></i></a>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row ">
                    ...
                    <div class="col-md-6 col-lg-6">
                        ...
                        <h2 class="title-head">Aprueba tu examén parcial con el mejor desarrollo</h2>


                        <p>Somos Expertos en Diseño y Desarrollo de Webs, tiendas virtuales y sistemas, APPs y Posicionamiento SEO. Creamos
        ...
        <section id="pricing" class="padd-80">
            <div class="container">
                ...
                <div class="row">
                    <div class=" col-md-6 offset-md-3">
                        <div class="text-center">
                            ...
                            <p class="font-p mg-tp-30 mg-bt-30">
                                ...
                                <br>
                                Entrega entre 5 – 7 Días | Soporte Técnico los 365 días | Satisfacción 100% Garantizada
                    ...
                    <div class="col-md-6 offset-md-3 offset-lg-3 col-sm-4 col-lg-6">
                        ...
                        <div class="prining-table">
                            <div class="pricing-table-inner fadeInLeft">
                                ...
                                <ul>
                                    ...
                                    <li class="price color-1"> <span>s/. 250.00</span></li>
                                    ...
                                    <li class="table-content">
                                        ...
                                        <ul>
                                            ...
                                            <li>☑ Hosting Incluído </li>
                                            <li>☑ Versión ligera para Mobile</li>
                                            <li>☑ Diseño y desarrollo único.</li>
                                            <li>☑ Soporte 24/7.</li>
                                    ...
                                    <li class="button-p">
                                        ...
                                        <a href="{{asset('/landing/examen-parcial-tienda.pdf')}}" target="_blank" class="btn btn-blue" title="Paquete de promoción Tienda Virtual">Ver Plan Completo <i class="fa fa-file-pdf-o"></i></a>
                ...
                <div class="col-md-6 col-lg-6 padd-0">
                    ...
                    <div class="text-carousel">
                        ...
                        <div class="content-text-slick" data-index="0">
                            ...
                            <p>Al ser expertos en posicionamiento web, las páginas web que Ccente System desarrolla no
                                sólo
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                       ...
                       <p>¡EXPERTOS EN DESARROLLO! Las páginas web, Tiendas Virtuales y Sistemas que CCENTE SYSTEM desarrolla no sólo son atractivas para sus usuarios, sino también para Google.</p>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <div class="logo-footer ">
                                    <img src="{{asset('/landing/logo-ccente-system.png')}}" alt="Ccente System" title="Ccente System">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            ...
                            <div class="copyright ">
                                <p>2020 © creado por <a href="https://www.ccentesystem.com" title="Ccente System">Ccente System</a>.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <ul class="list-social list-inline">
                                <li>
                                    <a href="https://www.facebook.com/ccentesystem/" target="_blank" title="Ccente System en Facebook">
                                        <i class="social_facebook"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/ccentesystem/" target="_blank" title="Ccente System en Instagram">
                                        <i class="social_instagram"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/CcenteSystem" target="_blank" title="Ccente System en Twitter">
                                        <i class="social_twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/company/ccente-system" target="_blank" title="Ccente System en Linkedin">
