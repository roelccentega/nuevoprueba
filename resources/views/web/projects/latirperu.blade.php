                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="ttm_pf_image-wrapper">
                                            <a href="{{url('/proyectos/latir-peru')}}" target="_blank">
                                                <img class="img-fluid" src="{{asset('company/images/projects/latirperu.png')}}" alt="portfolio-img">
                                            </a>
                                        ...
                                        <div class="ttm-pf-single-content-area mt-40">
                                            <div class="pb-15">
                                                ...
                                                <p>El encargo era construír una presencia en Internet para la empresa <a
                                                            href="https://www.latirperu.com" target="_blank">Latir Perú</a> y poder tener contacto digital con los posibles clientes interesados en los servicios de Aire acondicionado y mantenimiento que ofrece la empresa.</p>
