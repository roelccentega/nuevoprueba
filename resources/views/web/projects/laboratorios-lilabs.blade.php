                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-7 col-xl-8">
                                        ...
                                        <div class="ttm_pf_image-wrapper">
                                            <img class="img-fluid" src="{{asset('company/images/projects/index-laboratorio.png')}}" alt="portfolio-img">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ttm-pf-single-content-area mt-40">
                                            <div class="pb-15">
                                                <h3>Laboratorio Lilabs</h3>
                                                <p>El encargo por la empresa de desarrollo Wilaii era construír una página web profesional para<a
                                                            href="">Laboratorio Lilabs</a> y poder tener contacto digital con los posibles clientes interesados en los servicios que ofrece la empresa.</p>

                                                <p>La empresa ya contaba con un dominio .pe, es un dominio con un alcance regional muy bueno para tener una mejor presencia en el país donde opera actualmente la empresa.</p>
                                            ...
                                            <p>Para ello creamos las siguiente urls que albergan la información necesaria para indexar el contenido de Laboratorio Lilabs en Internet:</p>
